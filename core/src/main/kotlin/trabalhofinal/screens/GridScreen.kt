...
//        pl.mapPos = IVector2(22,1)
//        pl2.mapPos = IVector2(21,1)
//        players.add(pl)
//        players.add(pl2)
...
//            grid[player.mapPos.i][player.mapPos.j].component = player
//            return
//        }
//
//        val dest = player.destQueue.first()
//
//        val dir = dest - player.mapPos
//        player.mapPos = getTilePos(player.y - dir.j*tileHeight/2, WIDTH - player.x - dir.i*tileWidth/2)
