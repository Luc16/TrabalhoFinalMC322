...
class RayCastingTestScreen(game: MyGame): CustomScreen(game) {
    ...
    private val barrel = Component(Texture(Gdx.files.local("assets/wolftex/pics/barrel-no-bg.png")), Vector2())
    ...
    override fun show() {
        ...
        barrel.pos.set(tileWidth*12 + tileWidth, HEIGHT - tileHeight*3 + tileHeight/2)
